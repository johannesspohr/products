...
public class GtinValidator implements ConstraintValidator<ValidGtin, String> {
    ...
    @Override
    public void initialize(final ValidGtin annotation) {
        // noop
    }
    ...
    public boolean isValid(final String value) {
        return numeric.matcher(value).find() && checkGTIN(value);
    }
     ...
     *
     * Function taken from https://github.com/TheGeekExplorer/GTIN-Validation/blob/master/Java/CheckGTIN.java
     *
     * @param string gtin
     * @return bool */
